<template>
  <div class="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
    <div class="flex flex-col-reverse">
      <div class="mt-4">
        <h1 class="line-clamp-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">
          {{ product.name }}
        </h1>
      ...
      <div>
        ...
        <div class="flex items-center">
          <Icon v-for="rating in [0, 1, 2, 3, 4]" :key="rating" name="ic:round-star-rate" :class="[reviews.average > rating ? 'text-yellow-400' : 'text-gray-300', 'h-5 w-5 shrink-0']" aria-hidden="true" />
        </div>
        <p class="sr-only">
    ...
    <div class="mt-10 border-t border-gray-200 pt-10">
      ...
      <p class="mt-4 text-sm text-gray-500">
        ...
        <a href="#" class="text-primary-600 font-medium hover:text-indigo-500">Read full license</a>
      </p>
    </div>
