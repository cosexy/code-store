<template>
  <div v-auto-animate class="space-y-2">
    ...
    <div
      :class="{
        'flex rounded-md bg-white/5 ring-1 ring-inset ring-white/10 focus-within:ring-2 focus-within:ring-inset': prefix,
        'ring-rose-500 focus-within:ring-rose-500': prefix && message,
        'focus-within:ring-indigo-500': prefix && !message
      }"
    >
      <span v-if="prefix" class="flex select-none items-center pl-3 text-gray-400 sm:text-sm">
        {{ prefix }}
      </span>
