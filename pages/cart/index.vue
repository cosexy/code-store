            ...
            <li v-for="(product, productIdx) in products" :key="product.id" class="flex py-6 sm:py-10">
              ...
              <div class="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                ...
                <p class="mt-4 flex space-x-2 text-sm text-gray-700">
                  <CheckIcon v-if="product.inStock" class="h-5 w-5 shrink-0 text-green-500" aria-hidden="true" />
                  <ClockIcon v-else class="h-5 w-5 shrink-0 text-gray-300" aria-hidden="true" />
